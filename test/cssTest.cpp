...
static void StyleAddPropertyTest() {
  ...
  style.add_property(_t("border-front"), _t("5px solid red"), nullptr, false);
  style.add_property(_t("border-back"), _t("5px solid red"), nullptr, false);
  ...
  style.add_property(_t("border-bottom-left-radius"), _t("1 2 3"), nullptr, false);
  ...
  style.add_property(_t("border-bottom-right-radius"), _t("1 2 3"), nullptr, false);
  ...
  style.add_property(_t("border-top-right-radius"), _t("1 2 3"), nullptr, false);
  ...
  style.add_property(_t("border-top-left-radius"), _t("1 2 3"), nullptr, false);
  style.add_property(_t("border-radius"), _t("1"), nullptr, false);
  style.add_property(_t("border-radius"), _t("1 2"), nullptr, false);
  style.add_property(_t("border-radius"), _t("1 2 3"), nullptr, false);
  ...
  style.add_property(_t("border-radius-z"), _t("1"), nullptr, false);
  style.add_property(_t("border-radius-z"), _t("1 2"), nullptr, false);
  style.add_property(_t("border-radius-z"), _t("1 2 3"), nullptr, false);
  style.add_property(_t("border-radius-z"), _t("1 2 3 4"), nullptr, false);
  ...
  style.add_property(_t("border-bottom"), _t("TBD"), nullptr, false);
  style.add_property(_t("border-bottom"), _t("TBD"), nullptr, false);
  style.add_property(_t("border-front"), _t("TBD"), nullptr, false);
  style.add_property(_t("border-front"), _t("TBD"), nullptr, false);
  style.add_property(_t("border-front"), _t("TBD"), nullptr, false);
  style.add_property(_t("border-front"), _t("TBD"), nullptr, false);
  style.add_property(_t("border-back"), _t("TBD"), nullptr, false);
  style.add_property(_t("border-back"), _t("TBD"), nullptr, false);
  style.add_property(_t("border-back"), _t("TBD"), nullptr, false);
  style.add_property(_t("border-back"), _t("TBD"), nullptr, false);
