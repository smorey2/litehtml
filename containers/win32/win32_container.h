...
namespace litehtml
{
	...
	public:
		...
		virtual void		load_image(const wchar_t* src, const wchar_t* baseurl, const litehtml::string_map* attrs, bool redraw_on_ready);
		virtual void		get_image_size(const wchar_t* src, const wchar_t* baseurl, const litehtml::string_map* attrs, litehtml::size& sz);
